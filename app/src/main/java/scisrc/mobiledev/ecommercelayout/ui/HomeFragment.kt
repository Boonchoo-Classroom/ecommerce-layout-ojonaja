...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        recommendedProducts.add(ProductModel("Jordan 1", " Low x Travis Scott “Medium Olive” ", 20000.00, R.drawable.olive))
        recommendedProducts.add(ProductModel("Jordan 1 ", "OG SP Travis Scott Reverse Mocha", 45000.00, R.drawable.mocha))
        recommendedProducts.add(ProductModel("Jordan 1", "Hyper Royal", 5800.00, R.drawable.hyper))
        ...
        promotionsList.add(ProductModel("คูปองส่วนลด", "รับคูปองส่วนลด 500 บาท", 44500.00, R.drawable.mocha))
